 ...
 * </p>
 * <ul>
 *   <li>{@link caex.caex30.caex.impl.CopyrightImpl#getValue <em>Value</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.CopyrightImpl#getChangeMode <em>Change Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CopyrightImpl extends MinimalEObjectImpl.Container implements Copyright {
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEXPackage.COPYRIGHT__CHANGE_MODE, oldChangeMode, changeMode));
	}
