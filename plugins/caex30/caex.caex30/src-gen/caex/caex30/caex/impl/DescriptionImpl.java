 ...
 * </p>
 * <ul>
 *   <li>{@link caex.caex30.caex.impl.DescriptionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link caex.caex30.caex.impl.DescriptionImpl#getChangeMode <em>Change Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptionImpl extends MinimalEObjectImpl.Container implements Description {
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEXPackage.DESCRIPTION__CHANGE_MODE, oldChangeMode, changeMode));
	}
